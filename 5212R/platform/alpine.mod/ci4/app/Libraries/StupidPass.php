...
class StupidPass {
    ...
    public function __construct($maxlen = 40, $environ = array() , $dict = null, $lang = null) {
        ...
        $this->dict = (isset($dict)) ? $dict : '/usr/sausalito/ui/chorizo/ci4/app/Libraries/stupid-pass/StupidPass.default.dict';
    ...
    public function validate($pass) {
        ...
        // For BlueOnyx we disable these three tests as they are a pain in the ass:
        //$this->upper();
        //$this->lower();
        //$this->special();
        $this->extrapolate();
