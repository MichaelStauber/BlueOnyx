...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .wrap-panel table.table-borderless thead > tr.thead-cols th {
                font-size: 78%;
                text-transform: uppercase;
            } /* thead meta */
            .wrap-panel table thead > tr.thead-min th.meta-label,
            .wrap-panel table thead > tr.thead-avg th.meta-label,
            .wrap-panel table tfoot > tr.tfoot-totals th.meta-label,
            .wrap-panel table thead > tr.thead-max th.meta-label {
                font-weight: bold;
                text-transform: uppercase;
            }
            .wrap-panel table .thead-min,
            .wrap-panel table .thead-avg,
            .wrap-panel table .thead-max {
                background: #f8f8f8;
            }
            .wrap-panel table .thead-avg {
                border-bottom: 2px solid #000;
            }
            .wrap-panel table thead > tr.thead-min th,
            .wrap-panel table thead > tr.thead-avg th,
            .wrap-panel table thead > tr.thead-max th {
                font-size: smaller;
                font-weight: normal;
                padding: 3px 8px 3px 8px;
                text-transform: inherit;
            }
            .wrap-panel table .thead-min th,
            .wrap-panel table .thead-avg th,
            .wrap-panel table .thead-max th {
                padding: 3px;
            }
            ...
            .wrap-panel table > thead > tr.thead-cols {
            ...
            .wrap-panel .row:nth-child(2):not(.table-wrapper) > .col-md-12 {
                padding: 0;
            } /* GENERAL */
            .wrap-general {
                position: relative;
            ...
            .dark.blue .wrap-panel table tfoot > tr > th {
                border-top: 1px dotted #999;
            }
            .dark.blue .wrap-panel table .thead-min,
            .dark.blue .wrap-panel table .thead-avg,
            .dark.blue .wrap-panel table .thead-max {
                background: #1f2328;
            }
            .dark.blue .wrap-panel table .thead-avg {
                border-bottom: 2px solid #999;
            }
            .dark.blue .wrap-panel table > thead > tr.thead-cols {
                border-bottom: 2px solid #999;
            }
            ...
            .dark.gray .wrap-panel table tfoot > tr > th {
                border-top: 1px dotted #999;
            }
            .dark.gray .wrap-panel table .thead-min,
            .dark.gray .wrap-panel table .thead-avg,
            .dark.gray .wrap-panel table .thead-max {
                background: #1c1c1c;
            }
            .dark.gray .wrap-panel table .thead-avg {
                border-bottom: 2px solid #999;
            }
            .dark.gray .wrap-panel table > thead > tr.thead-cols {
                border-bottom: 2px solid #999;
            }
            ...
            .dark.purple .wrap-panel table tfoot > tr > th {
                border-top: 1px dotted #999;
            }
            .dark.purple .wrap-panel table .thead-min,
            .dark.purple .wrap-panel table .thead-avg,
            .dark.purple .wrap-panel table .thead-max {
                background: #27293d;
            }
            .dark.purple .wrap-panel table .thead-avg {
                border-bottom: 2px solid #999;
            }
            .dark.purple .wrap-panel table > thead > tr.thead-cols {
                border-bottom: 2px solid #999;
            }
            .dark.purple .gray {
                    ...
                    <div class="col-md-12">
                        <div class="page-header clearfix">
                            <div class="pull-right">
                                <h4>
                                    <span class="label label-info" style="display: block;"><span class="hidden-xs">Last Updated: </span><span class="last-updated">2022-12-24 18:36:21 -0500</span></span>
                                </h4>
                            </div>
                            <h1 class="h-dashboard">
                                <span class="hidden-xs hidden-sm"><i class="fa fa-tachometer"></i> Dashboard</span>
                                <span class="visible-xs visible-sm"><i class="fa fa-bars nav-minibars"></i><i class="fa fa-circle nav-ws-status mini"></i></span>
                            </h1>
        ...
        <script type="text/javascript">
            ...
            var user_interface = {
                general: {
                    ...
                    desc: "",
                    items: {
                        total_requests: { className: "black", dataType: "numeric", label: "Total Requests" },
                        valid_requests: { className: "green", dataType: "numeric", label: "Valid Requests" },
                        failed_requests: { className: "red", dataType: "numeric", label: "Failed Requests" },
                        generation_time: { className: "gray", dataType: "secs", label: "Log Parsing Time" },
                        unique_visitors: { className: "blue", dataType: "numeric", label: "Unique Visitors" },
                ...
                visitors: {
                    ...
                    plot: [
                        { className: "hits-visitors", label: "Hits/Visitors", chartType: "area-spline", chartReverse: 1, redrawOnExpand: 1, d3: { y0: { key: "hits", label: "Hits" }, y1: { key: "visitors", label: "Visitors" } } },
                        { className: "bandwidth", label: "Tx. Amount", chartType: "area-spline", chartReverse: 1, redrawOnExpand: 1, d3: { y0: { key: "bytes", label: "Tx. Amount", format: "bytes" } } },
                    ],
                    items: [
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "hits", label: "Hits" },
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "visitors", label: "Visitors" },
                        { colWidth: "12%", meta: "count", dataType: "bytes", key: "bytes", label: "Tx. Amount" },
                        { className: "trunc", colWidth: "100%", meta: "unique", metaType: "numeric", metaLabel: "Total", dataType: "date", key: "data", label: "Data" },
                    ],
                },
                requests: {
                    ...
                    plot: [
                        {
                            ...
                            chartReverse: 0,
                            redrawOnExpand: 0,
                            d3: { x: { key: ["method", "data", "protocol"] }, y0: { key: "hits", label: "Hits" }, y1: { key: "visitors", label: "Visitors" } },
                        },
                        { className: "bandwidth", label: "Tx. Amount", chartType: "bar", chartReverse: 0, redrawOnExpand: 0, d3: { x: { key: ["method", "protocol", "data"] }, y0: { key: "bytes", label: "Tx. Amount", format: "bytes" } } },
                    ],
                    items: [
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "hits", label: "Hits" },
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "visitors", label: "Visitors" },
                        ...
                        { colWidth: "7%", dataType: "string", key: "protocol", label: "Protocol" },
                        { className: "trunc", colWidth: "100%", meta: "unique", metaType: "numeric", metaLabel: "Total", dataType: "string", key: "data", label: "Data" },
                    ],
                },
                static_requests: {
                ...
                hosts: {
                    ...
                    sort: { field: "hits", order: "DESC" },
                    plot: [
                        { className: "hits-visitors", label: "Hits/Visitors", chartType: "bar", chartReverse: 0, redrawOnExpand: 0, d3: { y0: { key: "hits", label: "Hits" }, y1: { key: "visitors", label: "Visitors" } } },
                        { className: "bandwidth", label: "Tx. Amount", chartType: "bar", chartReverse: 0, redrawOnExpand: 0, d3: { y0: { key: "bytes", label: "Tx. Amount", format: "bytes" } } },
                    ],
                    items: [
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "hits", label: "Hits" },
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "visitors", label: "Visitors" },
                ...
                os: {
                    ...
                    sort: { field: "hits", order: "DESC" },
                    plot: [
                        { className: "hits-visitors", label: "Hits/Visitors", chartType: "bar", chartReverse: 0, redrawOnExpand: 1, d3: { y0: { key: "hits", label: "Hits" }, y1: { key: "visitors", label: "Visitors" } } },
                        { className: "bandwidth", label: "Tx. Amount", chartType: "bar", chartReverse: 0, redrawOnExpand: 1, d3: { y0: { key: "bytes", label: "Tx. Amount", format: "bytes" } } },
                    ],
                    items: [
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "hits", label: "Hits" },
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "visitors", label: "Visitors" },
                ...
                visit_time: {
                    ...
                    plot: [
                        { className: "hits-visitors", label: "Hits/Visitors", chartType: "area-spline", chartReverse: 0, redrawOnExpand: 1, d3: { y0: { key: "hits", label: "Hits" }, y1: { key: "visitors", label: "Visitors" } } },
                        { className: "bandwidth", label: "Tx. Amount", chartType: "area-spline", chartReverse: 0, redrawOnExpand: 1, d3: { y0: { key: "bytes", label: "Tx. Amount", format: "bytes" } } },
                    ],
                    items: [
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "hits", label: "Hits" },
                        { colWidth: "12%", meta: "count", dataType: "numeric", key: "visitors", label: "Visitors" },
            ...
            !(function () {
                ...
                function _t(n, t, e) {
                    var r,
                        ...
                        c = (o + i) / 2;
                    return (
                        a ? ((u = 0.5 > c ? a / (o + i) : a / (2 - o - i)), (r = n == o ? (t - e) / a + (e > t ? 6 : 0) : t == o ? (e - n) / a + 2 : (n - t) / a + 4), (r *= 60)) : ((r = 0 / 0), (u = c > 0 && 1 > c ? 0 : r)), new at(r, u, c)
                    );
                }
                function wt(n, t, e) {
                        ...
                        return {
                            ...
                            point: function (f, h) {
                                ...
                                if ((!e && (l = c = v) && n.lineStart(), v !== c && ((g = r(e, p)), (be(e, g) || be(p, g)) && ((p[0] += Ca), (p[1] += Ca), (v = t(p[0], p[1])))), v !== c))
                                    ...
                                    d & i ||
                                        !(m = r(p, e, !0)) ||
                                        ((s = 0), o ? (n.lineStart(), n.point(m[0][0], m[0][1]), n.point(m[1][0], m[1][1]), n.lineEnd()) : (n.point(m[1][0], m[1][1]), n.lineEnd(), n.lineStart(), n.point(m[0][0], m[0][1])));
                                }
                ...
                (ta.interpolateTransform = Hu),
                    ...
                    (ta.layout.force = function () {
                        ...
                        return (
                            (a.tick = function () {
                                ...
                                for (e = 0; _ > e; ++e)
                                    (a = M[e]),
                                        ...
                                        (x = h.y - f.y),
                                        (p = y * y + x * x) &&
                                            ((p = (r * i[e] * ((p = Math.sqrt(p)) - u[e])) / p), (y *= p), (x *= p), (h.x -= y * (d = f.weight / (h.weight + f.weight))), (h.y -= x * d), (f.x += y * (d = 1 - d)), (f.y += x * d));
                            ...
                            (a.drag = function () {
                                return (
                                    e || (e = ta.behavior.drag().origin(y).on("dragstart.force", Xu).on("drag.force", t).on("dragend.force", $u)), arguments.length ? void this.on("mouseover.force", Bu).on("mouseout.force", Wu).call(e) : e
                                );
                            }),
                            ta.rebind(a, c, "on")
                        );
                        ...
                        function n() {
                            ...
                            if (
                                ((m = (+c.apply(this, arguments) || 0) / 2) &&
                                    ((d = i === kl ? Math.sqrt(n * n + l * l) : +i.apply(this, arguments)), g || (A *= -1), l && (A = tt((d / l) * Math.sin(m))), n && (E = tt((d / n) * Math.sin(m)))),
                                l)
                            ) {
            ...
            (function () {
                ...
                window.GoAccess = window.GoAccess || {
                    initialize: function (options) {
                        ...
                        if (Object.keys(this.AppWSConn).length) this.setWebSocket(this.AppWSConn);
                    },
                    ...
                    reconnect: function (wsConn) {
                        ...
                        this.retries++;
                        if (this.currDelay < this.maxDelay) this.currDelay *= 2; // Exponential backoff
                ...
                GoAccess.OverallStats = {
                    ...
                    renderData: function (data, ui) {
                        ...
                        $(".wrap-general").innerHTML = GoAccess.AppTpls.General.wrap.render(
                            GoAccess.Util.merge(ui, {
                ...
                GoAccess.Panels = {
                    ...
                    renderPanel: function (panel, ui, col) {
                        ...
                        var box = document.createElement("div");
                        box.id = "panel-" + panel;
                        box.innerHTML = GoAccess.AppTpls.Panels.wrap.render(
                            GoAccess.Util.merge(ui, {
                                labels: GoAccess.i18n,
                            })
                        );
