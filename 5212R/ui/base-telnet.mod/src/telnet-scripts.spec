...
* Sun Nov 20 2022 Michael Stauber <mstauber@solarspeed.net> 1.2.1-1
- Release version for BlueOnyx 5211R

* Mon Jul 08 2019 Michael Stauber <mstauber@solarspeed.net> 1.2.0-1
- Modified initTelnet.sh to create /etc/xinetd.d/telnet with sane
  content, as 'telnet-server' on EL8 doesn't have that file.
