...
* Tue Nov 25 2015 Michael Stauber <mstauber@solarspeed.net> 1.0.4-1
- Overhauled am_ftp.exp to clean up the syntax.

* Wed Oct 14 2015 Michael Stauber <mstauber@solarspeed.net> 1.0.3-0BX03
- Changed am_ftp.exp to check against 127.0.0.1 instead of localhost.
