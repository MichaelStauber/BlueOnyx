...
<?php echo $daemon_spinner_element; ?>
                    <!-- Display Vsite/User Quicksearch -->
<?php echo $vsite_and_user_quicksearch_menu; ?>                    
                    <!-- /Display Vsite/User Quicksearch -->
                    <!-- Active Monitor Display -->
<?php echo $ActiveMonitorDisplay; ?>

                    <!-- /Active Monitor Display -->
                    <li class="dropdown auth-drp">

                        <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><i class="fa fa-sign-out top-nav-icon"></i></a>
                        <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                            <li>
                                <a href="javascript:void(0);" data-toggle="modal" data-target="#logout_modal" data-whatever="logout"><i class="zmdi zmdi-power"></i><span><?php echo $logout_text; ?></span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="fixed-sidebar-left">
            ...
            <ul class="nav navbar-nav side-nav nicescroll-bar">
                <li class="navigation-header">
                    <span><?php echo $Categories_text; ?></span> 
                    <i class="zmdi zmdi-more"></i>
                </li>
<?php echo $nav_html_menu; ?>
                <!-- /Category Menu -->

                <li><hr class="light-grey-hr mb-5"/></li>
                <li class="navigation-header">
                    <span><?php echo $Options_text; ?></span> 
                    <i class="zmdi zmdi-more"></i>
                </li>
