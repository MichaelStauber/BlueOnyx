...
$(CCESHLIB): $(CCESHLIBOBJS)
	...
	$(CC) $(CCESHAREDLDDEFS) $(LDSHAREDFLAGS) -Wl,-soname,$(CCESHLIB_MAJ) -o $(CCESHLIB) $(CCESHLIBOBJS) -Wl,-rpath-link,$(CCELIBDIR) -L$(CCELIBDIR) $(CCESHLIB_LIBS)
...
$(CCESHLIB_NOVERS): $(CCESHLIBOBJS)
	...
	$(CC) $(CCESHAREDLDDEFS) $(LDSHAREDFLAGS) $(CCESHLIBOBJS) -o $(CCESHLIB_NOVERS) -Wl,-rpath-link,$(CCELIBDIR) -L$(CCELIBDIR) $(CCESHLIB_LIBS)
