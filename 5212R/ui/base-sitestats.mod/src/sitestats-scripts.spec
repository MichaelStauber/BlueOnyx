...
* Tue Mar 14 2023 Michael Stauber <mstauber@solarspeed.net> 2.3-6
- Added /etc/logrotate.d/suphp

* Fri Feb 24 2023 Michael Stauber <mstauber@solarspeed.net> 2.3-5
- Turned debugging off in sitestats-scripts/split_logs

* Thu Dec 29 2022 Michael Stauber <mstauber@solarspeed.net> 2.3-4
- Moved GoAccess parsing of combined access log past STDIN calls.

* Tue Dec 27 2022 Michael Stauber <mstauber@solarspeed.net> 2.3-3
- Added Swatch scripts for GoAccess and Monitorix

* Mon Dec 26 2022 Michael Stauber <mstauber@solarspeed.net> 2.3-2
- Integrated GoAccess support into logrotate and split_logs
  This required more permissive directory permissions for the server
  and Vsite /var/logs directories as well.
- Modified post-install to NOT enable the blood iptables firewall
  anymore, as we use Firewalld.

* Sat Nov 19 2022 Michael Stauber <mstauber@solarspeed.net> 2.3-1
- Release version for BlueOnyx 5211R

* Sat Aug 20 2022 Michael Stauber <mstauber@solarspeed.net> 2.2-1BX05
- Updated anonip to v1.1.0 from https://pypi.org/project/anonip/

* Fri Feb 26 2021 Michael Stauber <mstauber@solarspeed.net> 2.2-1BX04
- Modified sitestats-scripts/sitestats_purgeOmatic.pl to allow /logs
  to contain less than a month worth of data and to also clean it out
  by disabling logging in general.

* Fri Jun 26 2020 Michael Stauber <mstauber@solarspeed.net> 2.2-1BX03
- Added check for Firewalld to /etc/cron.hourly/log_traffic.

* Thu Feb 27 2020 Michael Stauber <mstauber@solarspeed.net> 2.2-1BX02
- Fixed webalizer issue related to path change from jails.

* Sun Jun 07 2019 Michael Stauber <mstauber@solarspeed.net> 2.2-1BX01
- Introduced 5210R Vsite/User path changes.
- Modified sitestats-scripts/anonip.py
- Modified sitestats-scripts/grab_logs.pl
- Modified sitestats-scripts/sitestats_purgeOmatic.pl
- Modified sitestats-scripts/split_logs
- Modified sitestats-scripts/webalizer.pl
...
%attr(755,root,root) /usr/sausalito/swatch/bin/*
