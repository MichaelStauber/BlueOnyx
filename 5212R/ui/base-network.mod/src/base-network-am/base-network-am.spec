...
* Tue Oct 22 2024 Michael Stauber <mstauber@solarspeed.net> 1.1.1-1
- Modified am_network.sh to also work with VLAN interfaces

* Sat Jun 08 2024 Michael Stauber <mstauber@solarspeed.net> 1.1.0-1
- New am_network.sh rewritten to use NetworkManager conforming methods

* Tue Mar 26 2024 Michael Stauber <mstauber@solarspeed.net> 1.0.5-1
- Fix in am_network.sh for Incus and LXC containers with routed networks.

* Wed Oct 15 2019 Michael Stauber <mstauber@solarspeed.net> 1.0.4-1
- Fix in am_network.sh for CentOS 8 OpenVZ 7 containers.

* Fri Oct 10 2019 Michael Stauber <mstauber@solarspeed.net> 1.0.3-1
- Fix in am_network.sh for CentOS 8. IPADDR wasn't defined.
